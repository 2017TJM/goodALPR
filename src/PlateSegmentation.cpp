...
//        cv::waitKey(0);
    ...
    void PlateSegmentation::ExtractRegions(PlateInfo &plateInfo,std::vector<cv::Rect> &rects, std::string fileName){
...
//
			...
			std::string pathName = "C:\\Users\\Michael\\Desktop\\filePath5\\" + fileName + "#" + std::to_string(i) + ".jpg";
			//std::cout << pathName << std::endl;
			cv::imwrite(pathName, charImage);
